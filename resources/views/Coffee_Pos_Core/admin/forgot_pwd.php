...
if(isset($_POST['reset_pwd']))
{
    ...
    $checkEmail = mysqli_query($mysqli, "SELECT `admin_email` FROM `coffee_shop_admin` WHERE `admin_email` = '".$_POST['reset_email']."'") or exit(mysqli_error($mysqli));
    if( mysqli_num_rows($checkEmail) > 0 )  {
        ...
        $query="INSERT INTO coffee_shop_pass_resets (reset_email, reset_code, reset_token, reset_status) VALUES (?,?,?,?)";
