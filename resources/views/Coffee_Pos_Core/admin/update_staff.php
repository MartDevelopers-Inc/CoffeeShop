<?php
    ...
    if(isset($_POST['UpdateStaff']))
    {
         ...
         {  
             ...
             $postQuery="UPDATE coffee_shop_staff SET  staff_number =?, staff_name =?, staff_email =?, staff_password =? WHERE staff_id =?";
...
<body>
  ...
  <div class="main-content">
    ...
    <?php
        ...
        $update = $_GET['update'];
        $ret = "SELECT * FROM  coffee_shop_staff WHERE staff_id = '$update' "; 
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <input type="submit" name="UpdateStaff" value="Update Staff" class="btn btn-outline-success" value="">
                        </div>
                    </div>
                </form>
            </div>
