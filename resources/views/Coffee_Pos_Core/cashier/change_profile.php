...
if (isset($_POST['ChangeProfile'])) {
    ...
    $Qry = "UPDATE coffee_shop_staff SET staff_name =?, staff_email =? WHERE staff_id =?";
...
if (isset($_POST['changePassword'])) {
    ...
    if (!$error) {
        $staff_id = $_SESSION['staff_id'];
        $sql = "SELECT * FROM coffee_shop_staff   WHERE staff_id = '$staff_id'";
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if ($old_password != $row['staff_password']) {
                ...
                $query = "UPDATE coffee_shop_staff SET  staff_password =? WHERE staff_id =?";
...
<body>
    ...
    <div class="main-content">
        ...
        ?>
            <!-- Header -->
            <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(../admin/assets/img/theme/profile-cover.jpg); background-size: cover; background-position: center top;">
                <!-- Mask -->
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-3 order-lg-2">
                                    <div class="card-profile-image">
                                        <a href="#">
                                            <img src="../admin/assets/img/theme/admin.jpeg" class="rounded-circle">
                                        </a>
                                    </div>
                                </div>
                            </div>
