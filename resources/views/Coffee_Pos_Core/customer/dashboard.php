            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  $ret = "SELECT * FROM  coffee_shop_orders WHERE customer_id = '$customer_id' ORDER BY `coffee_shop_orders`.`created_at` ASC LIMIT 10 ";
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM   coffee_shop_payments WHERE customer_id ='$customer_id'   ORDER BY `coffee_shop_payments`.`created_at` DESC LIMIT 10 ";
                  $stmt = $mysqli->prepare($ret);
                  $stmt->execute();
                  $res = $stmt->get_result();
