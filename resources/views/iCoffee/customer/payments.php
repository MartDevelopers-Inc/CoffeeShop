                    ...
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <a href="orders.php" class="btn btn-outline-success">
                                <i class="fas fa-plus"></i> <i class="fas fa-coffee"></i>
                                Make A New Order
                            </a>
                        </div>
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    ...
                                    $ret = "SELECT * FROM  coffee_shop_orders WHERE order_status ='' AND customer_id = '$customer_id'  ORDER BY `coffee_shop_orders`.`created_at` DESC  ";
